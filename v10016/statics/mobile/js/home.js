        ...
        'Click':function(){
            $('body').on('click', 'a.mac_ulog', function(e){
                ...
                if(MAC.User.IsLogin == 0){
                    alert('您还没有登录哦！');
                    window.location.href=maccms.path + '/index.php/user/login'
                    return;
                }
    ...
    'Comment':{
        ...
        'Init':function(){
            ...
            $('body').on('click', '.comment_reply', function(e){
                ...
                if($that.attr("data-id")){
                    var str = $that.html();
                    var html = $('.comment_item').show();
                    html.addClass('comment_reply_form');
                    html.find('input[name="comment_pid"]').val( $that.attr("data-id") );
