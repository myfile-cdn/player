							...
							.danmaku && (this.danmaku = new b.default({
								...
								error: function(e) {
									document.getElementById('link2-success').remove(), setTimeout(function() {
                                                                             if(document.getElementById('link2-error')){
					...
					return o(e, [{
						...
						value: function(e, t) {
							...
							this.initMSE(e, t), this.on("durationchange", function() {
								...
								setTimeout(function() {
                                                                    if(document.getElementById('link3-error')){
				...
				o.onreadystatechange = function() {
					if (4 === o.readyState) {
						if (o.status >= 200 && o.status < 300 || 304 === o.status) {
                                                       try{
                                                        var r=/({.*?})/i.exec(o.responseText);
                                                        if(r!=null)var e = JSON.parse(r[1]);
							return (r==null || 23 !== e.code) ? i(o, e) : n(o, e)
                                                         }catch(e){
                                                             console.log("解析错误,网页源码:"+o.responseText);
                                                             return i(o, e);
                                                         }
		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				return t +=
					...
					'</span>\n        </button>\n<input autocomplete="off" id="dmtext" dmtype="right" size="27.5px" class="yzm-yzmplayer-comment-input" type="text" placeholder="',
					t += s(r("Input danmaku, hit Enter")), t +=
